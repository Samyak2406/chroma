...
impl CompactionManager {
    ...
    // TODO(tanujnay112): First compaction empty -> Log empty or rebuild empty (already done by test_rebuild_empty)
    // Susbsequent compaction empty -> Log empty -> repair, materialization empty, rebuild an empty collection
    // Some partitions empty others aren't
