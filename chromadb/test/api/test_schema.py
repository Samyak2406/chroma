...
def test_config_classes_reject_invalid_fields() -> None:
    ...
    error_msg = str(exc_info.value)
    assert "key" in error_msg.lower() or "invalid field" in error_msg.lower()
    assert "valid fields" in error_msg.lower() or "source_key" in error_msg.lower()
    ...
    error_msg = str(exc_info.value)
    assert "invalid_field" in error_msg.lower() or "invalid field" in error_msg.lower()
    ...
    error_msg = str(exc_info.value)
    assert "invalid_field" in error_msg.lower() or "invalid field" in error_msg.lower()
    assert "valid fields" in error_msg.lower() or "(none)" in error_msg.lower()
